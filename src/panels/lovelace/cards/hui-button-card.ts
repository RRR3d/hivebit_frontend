...
export class HuiButtonCard extends LitElement implements LovelaceCard {
  ...
  static get styles(): CSSResultGroup {
    return [
      ...
      css`
        ha-card {
          --state-inactive-color: var(--paper-item-icon-color, #e0e0e0);
          --state-color: var(--paper-item-icon-color, #e0e0e0);
        ...
        ha-card:focus-visible {
          ...
          --shadow-focus: 0 0 0 1px
            var(--state-color, var(--paper-item-icon-color, #e0e0e0));
          border-color: var(
            --state-color,
            var(--paper-item-icon-color, #e0e0e0)
          );
